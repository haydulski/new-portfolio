...
function Footer({ language, switchLanguage }) {
    useEffect(() => {
    }, [language])
    return (
        <Container>
            ...
            <ContactContainer>
                ...
                <div className="foot-icons">
                    <IconButton href="mailto:contact@prodeveloper.pl"><MailOutlineIcon sx={{ fill: '#f24405' }} /></IconButton>
                    <IconButton href="tel:+48796176358"><PhoneIcon sx={{ fill: '#f24405' }} /></IconButton>
                </div>
